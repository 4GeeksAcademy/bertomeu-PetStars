								...
								<div className="container">
									...
									<div className="collapse navbar-collapse" id="navbarNav">
										<ul className="navbar-nav ml-auto">
											<li className="nav-item"><a className="nav-link" href="/">Home</a></li>
											<li className="nav-item"><a className="nav-link" href="#">Foro</a></li>
											<li className="nav-item"><a className="btn btn-warning text-white ml-2" href="#">Join PetStar Now!</a></li>
											<li className="nav-item"><a className="nav-link" href="#">Log In</a></li>
											<li className="nav-item"><a className="btn btn-primary ml-2" href="#">Sign Up</a></li>
										</ul>
									</div>
								</div>
							</nav>
