          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Crear un nuevo post de texto</h5>
              </div>
              <div className="modal-body">
                <h6>Caption:</h6>
                <textarea className="form-control" placeholder="Add the caption of your post here" id="floatingTextarea2"></textarea>
                <div className="row p-2">
                  <button className="col-1 border rounded p-1 m-1 btn-light" onClick={() => console.log("Subir imagen")}>
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={() => console.log("Cerrar modal")}>
                  Close
                </button>
                <button type="button" className="btn btn-success" onClick={() => console.log("Publicar post")}>
                  Publish
                </button>
              </div>
            </div>
